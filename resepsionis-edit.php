            ...
            <div class="row">
                ...
                <div class="col-md-12"> 
                    <div class="contact-form">
                       ...
                       ?>
                       <form id="reservasi-tambah" action="reservasi-update.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <input type="hidden" name="id_reservasi" id="id_reservasi" value="<?php echo $data['id']?>">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <input type="text" class="form-control" id="status" name="status" placeholder="Masukan status kamar...">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
