...
<header class="">
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="index.php"><h2>ONESKA</h2></a>
            ...
            <div class="col-md-12">
                <div class="filters-content">
                    ...
                    <?php
                        ...
                        $previous = $hal - 1;
                        $next = $hal + 1;
                        $jumlah_data = mysqli_query($connect, "select count(*) as jumlah from kamar");
                        $jumlah = mysqli_fetch_array($jumlah_data); // jumlah data kamar
                        $total_hal = ceil($jumlah['jumlah'] / $batas);
                        $kamar = mysqli_query($connect, "select * from kamar limit $hal_awal, $batas");
                        while ($data = mysqli_fetch_array($kamar)) {
                            ...
                            <div class="oneska-item">
                                ...
                                <div class="down-content" style="min-height: 42vh" >
                                    <a href="#"><h4>' . $data['tipe'] . '</h4></a>
                                    <p>Tersedia: '. $data['jumlah'] . '</p>
                                    <hr>
                                    <h4>Fasilitas</h4>
                                    <p> ';
                                    $fasilitas = mysqli_query($connect, "select * from fasilitas_kamar WHERE 
                                    kamar_id =". $data['id']);
                                    while ($data_fasilitas = mysqli_fetch_array($fasilitas)){
                                        echo $data_fasilitas['nama'].'</li><br>';
                                    }
                                    echo'</p>
                                </div>
                            </div>
