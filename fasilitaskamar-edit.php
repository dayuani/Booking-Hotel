            ...
            <div class="row">
                ...
                <div class="col-md-12"> 
                    <div class="contact-form">
                       ...
                       $query = "select *from fasilitas_kamar where id='$id_fasilitas_kamar'";
                       $data = mysqli_query($connect, $query);
                       $data = mysqli_fetch_array($data);
                       ?>
                       <form id="fasilitaskamar-tambah" action="fasilitaskamar-update.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <input type="hidden" name="kamar_id" id="kamar_id" value="<?php echo $data['id']?>">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $data['nama']?>" placeholder="Masukkan tipe kamar...">
                                </div>
                            </div>
                            <div class="row">
