...
<body>
    ...
    <!-- Page Content -->
    <div class="page-heading header-text" style="background-nama: url(assets/namas/hotel3.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form id="fasilitas-tambah" action="fasilitas-tambah.php" method="post" enctype="multipart/form-data">
                            <div class="row">
