            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="contact-form">
                        <form id="kamar-tambah" action="kamar-tambah.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <input type="text" class="form-control" id="tipe" name="tipe" placeholder="Masukan Tipe Kamar...">
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12">
