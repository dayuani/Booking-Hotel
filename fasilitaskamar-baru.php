            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="contact-form">
                        <form id="fasilitaskamar-tambah" action="fasilitaskamar-tambah.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <input type="text" class="form-control" id="kamar_id" name="kamar_id" placeholder="Masukan kamarid...">
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan nama Fasilitas...">
                                </div>
                            </div>
