    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                ...
                <a href="fasilitaskamar-baru.php"><button type="button">Tambah Fasilitas Kamar</button></a>
                </div>
            <div class="col-md-6" style="text-align: right">
                <form action="admin-fasilitaskamar.php" method="get">
            ...
            <?php
               ...
               include "koneksi.php";
                if (isset($_GET['cari'])){
                    $cari =$_GET['cari'];
                    $query = "SELECT * FROM tampilkamar where tipe like'%".$cari."%'";
                } else {
                    $query = "SELECT *FROM tampilkamar";
                }
                ...
                while ($data = mysqli_fetch_array($sql)) {
                    ...
                    echo "<td>
                    <a href='fasilitaskamar-edit.php?id_fasilitas_kamar=".$data['id_fasilitas']."'>Edit |</a>
                    <a href='fasilitaskamar-hapus.php?id_fasilitas_kamar=".$data['id_fasilitas']."'>Hapus</a>
                    </td>";
                    echo "</tr>";
                }
                ?>
