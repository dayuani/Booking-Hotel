    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                ...
                <a href="fasilitas-baru.php"><button type="button">Tambah Fasilitas</button></a>
                </div>
            <div class="col-md-6" style="text-align: right">
                <form action="admin-fasilitas.php" method="get">
            ...
            <tbody>
                ...
                if (isset($_GET['cari'])){
                    $cari =$_GET['cari'];
                    $query = "SELECT * FROM fasilitas_hotel where nama like'%".$cari."%'";
                } else {
                ...
                while ($data = mysqli_fetch_array($sql)) {
                    ...
                    echo "<td>
                        <a href='fasilitas-edit.php?id_fasilitas_hotel=".$data['id']."'>Edit |</a>
                        <a href='fasilitas-hapus.php?id_fasilitas_hotel=".$data['id']."'>Hapus</a>
                    </td>";
                    echo "</tr>";
                }
                ?>
