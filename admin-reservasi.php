    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="filters">
                    <ul>
                        <h2>Admin reservasi Hotel ONESKA</h2>
                    </ul>
                </div>
            </div>
            <div class="col-md-12">
            <div class="row">
                ...
                <a href="reservasi-baru.php"><button type="button">Tambah Reservasi</button></a>
                </div>
            <div class="col-md-6" style="text-align: right">
                <form action="admin-reservasi.php" method="get">
            ...
            <?php
                ...
                if (isset($_GET['cari'])){
                    $cari =$_GET['cari'];
                    $query = "SELECT * FROM reservasi where nama_pemesan like'%".$cari."%'";
                } else {
                ...
                while ($data = mysqli_fetch_array($sql)) {
                    ...
                    echo "<td>".$data['hp']."</td>";
                    echo "<td>".$data['kamar_id']."</td>";
                    echo "<td>".$data['tgl_checkin']."</td>";
                    echo "<td>".$data['tgl_checkout']."</td>";
                    echo "<td>".$data['status']."</td>";
                    echo "<td>".$data['jumlah']."</td>";
                    echo "<td>
                        <a href='reservasi-edit.php?id_reservasi=".$data['id']."'>Edit </a> |
                        <a href='reservasi-hapus.php?id_reservasi=".$data['id']."'>Hapus</a> |
                    </td>";
                    echo "</tr>";
                }
                ?>
